    ...
    <table className="w-full border-collapse">
      <thead>
        <tr>
          ...
          <th className="text-[#111827] font-semibold text-sm text-left px-3 py-3.5">MiningModule</th>
          <th className="text-[#111827] font-semibold text-sm text-left px-3 py-3.5">GoldMine</th>
          <th className="text-[#111827] font-semibold text-sm text-left pl-3 py-3.5">UraniumMine</th>
        </tr>
      </thead>
      <tbody>
